...
type Posts struct {
	...
	Price            int       `gorm:"column:price;type:bigint"`
	...
	RoomCount        int       `gorm:"column:room_count;type:int(4)"`
	...
	CityName         string    `gorm:"column:city_name;type:varchar(45)"`
	NeighborhoodName string    `gorm:"column:neighborhood_name;type:varchar(45)"`
